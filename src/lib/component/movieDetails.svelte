...
<div class="rounded-sm">
	<div class="flex gap-3 transition-all w-full">
		<Shine>
		...
		<div class="flex flex-col justify-end w-full px-3">
			<div>
			...
			<p class="text-white/70 max-sm:text-xs font-thin text-wrap">{details.overview}</p>
		</div>
	</div>
</div>
